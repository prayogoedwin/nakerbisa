            ...
            <div class="__right">
                <header>
                    ...
                    <p>PEMERINTAHAN KABUPATEN REMBANG<br />
                        ...
                        <small>Jl. Pemuda KM 3 Kecamatan Rembang, Kabupaten Rembang, Jawa Tengah 59219<br />
                            Email:dinperinnaker@rembangkab.go.id |
                             https://dinperinnaker.rembangkab.go.id/ 
                        </small>
                    </p>
                </header>
                        ...
                        <div style="width: 100%;">
                            <div style="display: flex;">
                                ...
                                <div class="info-detail">
                                    <p style="margin-bottom: 0px;"><span>Nama Lengkap</span> {{ $user->pencari->name ?? '-' }}
                                    </p>

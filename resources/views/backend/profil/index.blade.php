                                                    ...
                                                    <form class="form form-vertical"
                                                        ...
                                                        <div class="form-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6">
                                                                    <div class="form-group">
                                                                        <label for="stsperkawinan"
                                                                            class="form-label">Status
                                                                            Perkawinan</label>
                                                                        <select class="form-select"
                                                                            id="status_perkawinan_id"
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-select" id="status_kerja_id"
                                                                        ...
                                                                        <option selected disabled>Pilih Status Kerja
                                                                        </option>
                                                                ...
                                                                <div id="pekerjaan-fields"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="jam_kerja" class="form-label">Jam
                                                                            Kerja
                                                                            (per hari)</label>
                                                            ...
                                                            @foreach ($pendidikan as $item)
                                                                <div class="list-group-item">
                                                                    ...
                                                                    <p><strong>Jurusan:</strong>
                                                                        {{ $item->jurusan_name ?? 'Tidak Ada Jurusan' }}
                                                                    </p>
                                                                    <p><strong>Tahun Lulus:</strong> {{ $item->lulus }}
                                                                    </p>
                                                                </div>
                                                            @endforeach
                                                        </div>

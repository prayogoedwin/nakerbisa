...
use App\Http\Controllers\RekapLowonganController;
use App\Http\Controllers\RekapPencariController;
use App\Http\Controllers\RekapPenempatanController;
...
Route::get('/depan/bkk', [DepanController::class, 'bkk'])->name('bkk');
...
Route::get('depan/lowongan-kerja-json', [DepanController::class, 'lowongan_kerja_json'])->name('depan.lowongan-kerja-json');
Route::get('/lowongan-kerja/{id}', [DepanController::class, 'showLowongan'])->name('lowongan.show');
...
Route::get('/depan/lowongan-kerja-ayokerjo', [DepanController::class, 'lowongan_kerja_ayokerjo'])->name('lowongan-kerja-ayokerjo');
...
Route::prefix('dapur')->middleware('auth')->group(function () {
    ...
    Route::prefix('users')->group(function () {
        ...
        Route::get('/blk', [UserBlkController::class, 'index'])->name('userblk.index');
        Route::delete('/blk/delete/{id}', [UserBlkController::class, 'softdelete'])->name('userblk.softdelete');
        Route::put('/blk/reset/{id}', [UserBlkController::class, 'reset'])->name('userblk.reset');
    });

...
class NakerInfografisController extends Controller
{
    //
    public function index(Request $request)
    {
        if ($request->ajax()) {
            $datas = NakerInfografis::select('id', 'name', 'path_file', 'status');
    ...
    public function destroy($id)
    {
        ...
        $data = NakerInfografis::findOrFail($id);
